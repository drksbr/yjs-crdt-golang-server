...
func TestMessageTypeValidAndString(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "document_sync_response_v2", typ: MessageTypeDocumentSyncResponseV2, want: "document-sync-response-v2", wantOK: true},
		{name: "document_update_v2", typ: MessageTypeDocumentUpdateV2, want: "document-update-v2", wantOK: true},
		{name: "document_sync_request_v2", typ: MessageTypeDocumentSyncRequestV2, want: "document-sync-request-v2", wantOK: true},
		{name: "document_update_v2_from_edge", typ: MessageTypeDocumentUpdateV2FromEdge, want: "document-update-v2-from-edge", wantOK: true},
