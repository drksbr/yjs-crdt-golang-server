# examples/echo-postgres

Este exemplo demonstra o adapter de `pkg/yhttp/echo` com persistência
PostgreSQL.
...
3. Adapta o handler para Echo com `yhttp/echo.Handler(...)`.
4. Expõe o endpoint WebSocket em `/ws`.

## Como executar

```bash
cd examples/echo-postgres
